                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="nilai_kkm" class="form-control" name="nilai_kkm" value="<?php echo $row['nilai_kkm'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="nilai_har"><b>Skor</b></label>
                                                            <input type="text" id="nilai_har" class="form-control" name="nilai_har" value="<?php echo $row['nilai_har'] ?>">
                                                        </div>
                                                    </div>
