                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="siswa.php">Siswa Ajar</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        name="noinduk_siswa" readonly value="<?=$data['noinduk_siswa']?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        name="NIK_walmur" readonly value="<?=$data['NIK_walmur']?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="last-name-column" class="form-control" 
                                                        name="nama_siswa" readonly value="<?=$data['nama_siswa']?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="country-floating" class="form-control"
                                                            name="tgllahir" readonly value="<?=$data['tgllahir']?>"> 
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="email-id-column" class="form-control"
                                                            name="tgl_masuk" readonly value="<?=$data['tgl_masuk']?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="country-floating" class="form-control"
                                                            name="alamat" readonly value="<?=$data['alamat']?>"> 
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
