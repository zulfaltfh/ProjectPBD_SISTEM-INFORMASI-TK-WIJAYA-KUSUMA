                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="nama_tugasprak"
                                                                class="form-control" name="nama_tugasprak" value="<?php echo $row['nama_tugasprak'];?>" maxlength="20" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="deskripsi_tugasprak"
                                                                name="deskripsi_tugasprak" value="" rows="6" maxlength="50" required><?php echo $row['deskripsi_tugasprak'];?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="start_tugas"
                                                                class="form-control" name="start_tugas" value="<?php echo $row['start_tugas'];?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="end_tugas"
                                                                class="form-control" name="end_tugas" value="<?php echo $row['end_tugas'];?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 d-flex justify-content-end mt-5">
                                                        <button type="submit"class="btn btn-primary me-2 mb-1" name="submit" value="submit">Simpan</button>
